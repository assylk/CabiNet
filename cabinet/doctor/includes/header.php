<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
    ...
    <div class="navbar-header">
        ...
        <a href="dashboard.php" class="navbar-brand">
            ...
            <span class="brand-name">CabiNet</span>
        </a>
    </div><!-- .navbar-header -->
...
{ 
  ...
  ?>
                        ...
                        <a href="view-appointment-detail.php?editid=<?php echo $row->ID;?>&&aptid=<?php echo $row->AppointmentNumber;?>"
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <small class="media-meta"><?php echo $row->AppointmentNumber;?> at
                                        (<?php echo $row->ApplyDate;?>)</small>
                                </div>
                            </div>
                        </a><!-- .media-group-item -->
                        <?php  } ?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu animated flipInY">
                        <li><a href="profile.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>My Profile</a>
                        </li>
