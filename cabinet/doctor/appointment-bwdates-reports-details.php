...
<head>
    ...
    <title>CabiNet || Dates Appointment Detail</title>
...
?>
                                <h5 align="center" style="color:blue">Appointement from <?php echo $fdate?> to
                                    <?php echo $tdate?></h5>
...
if($row->Status==''){
	echo "Not Updated Yet";
                                       ...
                                       echo htmlentities($row->Status);
                                            ...
                                            <?php $cnt=$cnt+1;}}else{ ?>
                                            <tr>
                                                <td colspan=7>No Appointement In this Periode
