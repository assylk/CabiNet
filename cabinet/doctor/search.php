...
<head>
    ...
    <title>CabiNet || Search Appointment Detail</title>
...
$sdata=$_POST['searchdata'];
  ?>
                            ...
                            <div class="widget-body">
								...
								$sql="SELECT * from tblappointment where AppointmentNumber like '$sdata%' || Name like '$sdata%' || MobileNumber like '$sdata%'|| CIN like '$sdata%' && Doctor=:docid";
								...
								{               ?>
                                            <tr>
                                                ...
                                                <td><?php  echo htmlentities($row->CIN);?></td>
