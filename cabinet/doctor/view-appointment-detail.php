...
if (strlen($_SESSION['damsid']==0)) {
 ...
 if(isset($_POST['submit']))
  { 
   ...
   $remark=$_POST['remark'];
      $ordannance=$_POST['ordannance'];

      $sql= "update tblappointment set Remark=:remark,Ordannance=:ordannance where ID=:eid";
    $query=$dbh->prepare($sql);
$query->bindParam(':remark',$remark,PDO::PARAM_STR);
$query->bindParam(':ordannance',$ordannance,PDO::PARAM_STR);

$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
 echo '<script>alert("Ordannace and Remark has been updated")</script>';
...
?>
                                    <p align="center" style="padding-top: 20px">
                                        <button class="btn btn-primary waves-effect waves-light w-lg"
                                            data-toggle="modal" data-target="#myModal">Add Ordonnance</button>
                                    </p>
                                                    ...
                                                    <table class="table table-bordered table-hover data-tables">
                                                        ...
                                                        <form method="post" name="submit">
                                                            ...
                                                            <tr>
                                                                <th>Ordannance :</th>
                                                                <td>
                                                                    <textarea name="ordannance"
                                                                        placeholder="Ecrire l'ordannance Medicale"
