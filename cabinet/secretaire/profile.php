...
if (strlen($_SESSION['damsid']==0)) {
  ...
  $email=$_POST['email'];
  $sql="update tblsecretaire set FullName=:name,MobileNumber=:mobilenumber,Email=:email where ID=:did";
...
<head>
    ...
    <title>CabiNet - Doctor Profile</title>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <?php
$did=$_SESSION['damsid'];
$sql="SELECT * from  tblsecretaire where tblsecretaire.ID=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                                <form class="form-horizontal" method="post">
                                    <div class="form-group">
                                        <label for="exampleTextInput1" class="col-sm-3 control-label">Employee
                                            ID:</label>
                                        <div class="col-sm-9">
                                            <input id="fname" type="text" class="form-control" placeholder="Full Name"
                                                name="fname" required="true" value="<?php  echo $row->FullName;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email2" name="mobilenumber"
