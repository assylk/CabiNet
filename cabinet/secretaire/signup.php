...
if(isset($_POST['submit']))
  {
    ...
    $ret="select Email from tblsecretaire where Email=:email";
...
if($query -> rowCount() == 0)
{
$sql="Insert Into tblsecretaire(FullName,MobileNumber,Email,Password)Values(:fname,:mobno,:email,:password)";
