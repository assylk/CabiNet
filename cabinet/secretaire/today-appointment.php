...
$sql="insert into tblappointment(AppointmentNumber,Name,CIN,MobileNumber,Email,AppointmentDate,AppointmentTime,Doctor,Message)values(:aptnumber,:name,:cin,:mobnum,:email,:appdate,:aaptime,:specialization,:message)";
                                ...
                                <td style="display: block">
                                    <p style="padding-top:12px;padding-left:12px;width:200px">
                                        <button class="btn btn-primary btn-label waves-effect waves-light "
                                            data-toggle="modal" data-target="#myModal"><img style="padding-right:10px;"
                                                src="../images/add.png" width="20%">Add Patient</button>
                                    </p>
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-bordered table-hover data-tables">
                                            ...
                                            <form method="post" name="submit">
                                                ...
                                                <tr>
                                                    <th>CIN :</th>
                                                    <td><input type="text" name="cin" id="cin" class="form-control"
                                                            placeholder="Numéro CIN" required='true'>
                                                    </td>
